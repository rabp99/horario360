<div>
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                <nav class="flex mb-5" aria-label="Breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="#" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Horarios</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <a href="{{ route('schedule.schedule-create') }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @forelse ($scheduleTypes as $key => $scheduleType)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-monday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-tuesday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-wednesday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-thursday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-friday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-saturday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <i data-tooltip-target="tooltip-default-sunday-{{ $key }}" data-tooltip-placement="bottom" class="fa-regular fa-circle-check text-green-500"></i>
    ...
    {{ $scheduleTypes->links('pagination-links-view') }}
