<div>
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                <nav class="flex mb-5" aria-label="Breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="#" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Cargos</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Cargos</h1>
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <a href="{{ route('position.position-create') }}" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    {{ $positions->links('pagination-links-view') }}
