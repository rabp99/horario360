        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <a
                        href="{{ route('employee.employee-create') }}"
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Nombre Completo</th>
                                <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Área</th>
                            ...
                            @forelse ($employees as $employee)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <a
                                            href="{{ route('employee.employee-edit', $employee->id) }}"
                                        ...
                                        <a
                                            href="{{ route('employee.employee-employment-history-index', $employee->id) }}"
                                        ...
                                        <button
                                            type="button"
                                            wire:click="setEmployeeToDelete({{ $employee->id }})"
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('employeeDeleteModal', () => ({
                ...
                init() {
                    this.deleteModal = new Modal(document.getElementById('delete-user-modal'), {
                    ...
                    // Escucha Livewire → cierra modal al eliminar
