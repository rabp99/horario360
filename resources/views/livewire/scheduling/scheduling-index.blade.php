<div>
            ...
            <div class="mb-4">
                <nav class="flex mb-5" aria-label="Breadcrumb">
                    ...
                    <li>
                        ...
                        <a href="#" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Programaciones}</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Programaciones</h1>
    ...
    <div id="accordion-collapse" data-accordion="collapse">
        @forelse ($schedulingPeriods as $schedulingPeriod)

        <h2 id="accordion-heading-{{ $schedulingPeriod->id }}">
            <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-body-{{ $schedulingPeriod->id }}" aria-expanded="false" aria-controls="accordion-body-{{ $schedulingPeriod->id }}">
                <span class="w-1/2 text-start">{{ $schedulingPeriod->month_name }} - {{ $schedulingPeriod->year }}</span>
                @if ($schedulingPeriod->state === 'ACTIVO')
        ...
        <div id="accordion-body-{{ $schedulingPeriod->id }}" class="hidden" aria-labelledby="accordion-heading-{{ $schedulingPeriod->id }}">
            <div class="border border-b-0 border-gray-200 dark:border-gray-700">
                            ...
                            <div class="overflow-hidden shadow">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                        @forelse ($schedulingPeriod->schedulingPeriodsAreas as $schedulingPeriodsArea)
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                                                {{ $schedulingPeriodsArea->area->name }}
                                            </td>
                                            ...
                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $schedulingPeriodsArea->actual_scheduled_employee_count }} / {{ $schedulingPeriodsArea->expected_scheduled_employee_count }}
                                            </td>

                                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                @switch($schedulingPeriodsArea->state)
                                                    @case('SIN INICIAR')
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-600 rounded-lg hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-900">
                                        ...
                                        @empty
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <td colspan="3" class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400 text-center">
                                                No hay registros
                                            </td>
                                        </tr>
                                        @endforelse
                ...
                @if (false)
                {{ $services->links('pagination-links-view') }}
                @endif
    ...
    {{ $schedulingPeriods->links('pagination-links-view') }}
